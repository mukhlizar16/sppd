<x-app-layout>
                            ...
                            @foreach ($uangs as $uang)
                                ...
                                <x-form_modal>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            class="form-control @error('total_harian') is-invalid @enderror"
                                            name="total_harian" id="total_harian"
                                            value="{{ old('total_harian', $uang->total_harian) }}" autofocus required>
                                        @error('total_harian')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            class="form-control @error('total_konsumsi') is-invalid @enderror"
                                            name="total_konsumsi" id="total_konsumsi"
                                            value="{{ old('total_konsumsi', $uang->total_konsumsi) }}" autofocus
                                            required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            class="form-control @error('total_transportasi') is-invalid @enderror"
                                            name="total_transportasi" id="total_transportasi"
                                            value="{{ old('total_transportasi', $uang->total_transportasi) }}"
                                            autofocus required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('total_representasi', $uang->total_representasi) }}"
                                            autofocus required>
    ...
    <x-form_modal>
        ...
        <div class="mb-3">
            <label for="harian" class="form-label">Harian</label>
            <input type="number" class="form-control @error('harian') is-invalid @enderror" name="harian"
                id="harian" value="{{ old('harian') }}" autofocus required>
            @error('harian')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            <label for="konsumsi" class="form-label">Konsumsi</label>
            <input type="number" class="form-control @error('konsumsi') is-invalid @enderror" name="konsumsi"
                id="konsumsi" value="{{ old('konsumsi') }}" autofocus required>
            @error('konsumsi')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('total_transportasi') is-invalid @enderror"
                name="total_transportasi" id="total_transportasi" value="{{ old('total_transportasi') }}" autofocus
                required>
            @error('total_transportasi')
                <div class="invalid-feedback">
                    {{ $message }}
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('total_representasi') is-invalid @enderror"
                name="total_representasi" id="total_representasi" value="{{ old('total_representasi') }}" autofocus
                required>
            @error('total_representasi')
                <div class="invalid-feedback">
                    {{ $message }}
