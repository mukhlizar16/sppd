                    ...
                    <form action="{{ route('pegawai.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="nama"
                                id="name" value="{{ old('nama') }}" autofocus required>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('gelar_depan') is-invalid @enderror"
                                name="gelar_depan" id="gelar_depan" value="{{ old('gelar_depan') }}" autofocus required>
                            @error('gelar_depan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('gelar_belakang') is-invalid @enderror"
                                name="gelar_belakang" id="gelar_belakang" value="{{ old('gelar_belakang') }}" autofocus
                                required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror"
                                name="tempat_lahir" id="tempat_lahir" value="{{ old('tempat_lahir') }}" autofocus required>
                            @error('tempat_lahir')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror"
                                name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir') }}" autofocus
                                required>
                            @error('tanggal_lahir')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nip_lama') is-invalid @enderror"
                                name="nip_lama" id="nip_lama" value="{{ old('nip_lama') }}" autofocus required>
                            @error('nip_lama')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nip_baru') is-invalid @enderror"
                                name="nip_baru" id="nip_baru" value="{{ old('nip_baru') }}" autofocus required>
                            @error('nip_baru')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('universitas') is-invalid @enderror"
                                name="universitas" id="universitas" value="{{ old('universitas') }}" autofocus required>
                            @error('universitas')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('jurusan') is-invalid @enderror"
                                name="jurusan" id="jurusan" value="{{ old('jurusan') }}" autofocus required>
                            @error('jurusan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('tingkat_ijazah') is-invalid @enderror"
                                name="tingkat_ijazah" id="tingkat_ijazah" value="{{ old('tingkat_ijazah') }}" autofocus
                                required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="1900" max="2099" step="1" value="2016"
                                ...
                                id="tahun_lulus" autofocus required>
                            @error('tahun_lulus')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tmt_cpns') is-invalid @enderror"
                                name="tmt_cpns" id="tmt_cpns" value="{{ old('tmt_cpns') }}" autofocus required>
                            @error('tmt_cpns')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('jabatan') is-invalid @enderror"
                                name="jabatan" id="jabatan" value="{{ old('jabatan') }}" autofocus required>
                            @error('jabatan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tmt_jabatan') is-invalid @enderror"
                                name="tmt_jabatan" id="tmt_jabatan" value="{{ old('tmt_jabatan') }}" autofocus required>
                            @error('tmt_jabatan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('masa_kerja_tahun') is-invalid @enderror"
                                name="masa_kerja_tahun" id="masa_kerja_tahun" value="{{ old('masa_kerja_tahun') }}"
                                autofocus required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('masa_kerja_bulan') is-invalid @enderror"
                                name="masa_kerja_bulan" id="masa_kerja_bulan" value="{{ old('masa_kerja_bulan') }}"
                                autofocus required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('unit_kerja') is-invalid @enderror"
                                name="unit_kerja" id="unit_kerja" value="{{ old('unit_kerja') }}" autofocus required>
                            @error('unit_kerja')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('instansi_induk') is-invalid @enderror"
                                name="instansi_induk" id="instansi_induk" value="{{ old('instansi_induk') }}" autofocus
                                required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('telp') is-invalid @enderror"
                                name="telp" id="telp" value="{{ old('telp') }}" autofocus required>
                            @error('telp')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('rencana_naik_gaji') is-invalid @enderror"
                                name="rencana_naik_gaji" id="rencana_naik_gaji" value="{{ old('rencana_naik_gaji') }}"
                                autofocus required>
