                    ...
                    <form action="{{ route('pegawai.update', $pegawai->id) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="nama"
                                id="name" value="{{ old('name', $pegawai->nama) }}" autofocus required>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('gelar_depan') is-invalid @enderror"
                                name="gelar_depan" id="gelar_depan" value="{{ old('gelar_depan', $pegawai->gelar_depan) }}"
                                autofocus required>
                            @error('gelar_depan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nip_lama') is-invalid @enderror"
                                name="nip_lama" id="nip_lama" value="{{ old('nip_lama', $pegawai->nip_lama) }}" autofocus
                                required>
                            @error('nip_lama')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nip_baru') is-invalid @enderror"
                                name="nip_baru" id="nip_baru" value="{{ old('nip_baru', $pegawai->nip_baru) }}" autofocus
                                required>
                            @error('nip_baru')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('jurusan') is-invalid @enderror"
                                name="jurusan" id="jurusan" value="{{ old('jurusan', $pegawai->jurusan) }}" autofocus
                                required>
                            @error('jurusan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('jabatan') is-invalid @enderror"
                                name="jabatan" id="jabatan" value="{{ old('jabatan', $pegawai->jabatan) }}" autofocus
                                required>
                            @error('jabatan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('unit_kerja') is-invalid @enderror"
                                name="unit_kerja" id="unit_kerja" value="{{ old('unit_kerja', $pegawai->unit_kerja) }}"
                                autofocus required>
                            @error('unit_kerja')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('alamat') is-invalid @enderror"
                                name="alamat" id="alamat" value="{{ old('alamat', $pegawai->alamat) }}" autofocus
                                required>
                            @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('rencana_naik_gaji') is-invalid @enderror"
                                ...
                                value="{{ old('rencana_naik_gaji', $pegawai->rencana_naik_gaji) }}" autofocus required>
